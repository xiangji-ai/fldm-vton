...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None,**kwargs):
        ...
        for module in self.output_blocks:
            ...
            # --------------- FreeU code -----------------------
            # 1.1 1.2 0.8 0.6
            # b1=1.2; b2=1.3; s1=0.7; s2=0.2
            # b1=1.1; b2=1.2 ; s1=0.8; s2=0.7
            # b1 =1.0; b2 = 1.1; s1 = 0.9; s2 = 0.2
            # b1 = 1.1;
            # b2 = 1.2;
            # s1 = 0.9;
            # s2 = 0.6
            b1 = 1.1;b2 = 1.2;s1 = 0.9;s2 = 0.6
            if h.shape[1] == 1280:
                ...
                h[:, :640] = h[:, :640] * ((b1 - 1) * hidden_mean + 1)
            ...
            if h.shape[1] == 640:
                ...
                h[:, :320] = h[:, :320] * ((b2 - 1) * hidden_mean + 1)
